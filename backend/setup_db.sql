...
-- 2. User Setup (Fixes "Access denied for user 'root'")
-- Create a dedicated user for the application
CREATE USER IF NOT EXISTS 'academic_admin'@'localhost' IDENTIFIED BY 'AcademicPass123!';

-- Grant specific privileges to this user
GRANT ALL PRIVILEGES ON academic_messaging.* TO 'academic_admin'@'localhost';
FLUSH PRIVILEGES;
...
INSERT IGNORE INTO automation_keywords (keyword) VALUES
